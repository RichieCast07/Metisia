...
export default function Modal({ isOpen, onClose, title, children, size = 'md' }: ModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center animate-[fadeIn_0.15s_ease-out]">
      ...
      <div className={`relative bg-white rounded-2xl shadow-modal w-full ${sizeMap[size]} mx-4 max-h-[85vh] flex flex-col animate-[slideUp_0.2s_ease-out] ring-1 ring-black/10`}>
